...
inst: all
	...
	cp rda-bg-normal.jpeg rda-bg-title1.jpeg rda-bg-title2.jpeg $(UTREE)/tex/latex/$(NAME)
...
install: all
	...
	cp rda-bg-normal.jpeg rda-bg-title1.jpeg rda-bg-title2.jpeg $(LOCAL)/tex/latex/$(NAME)
...
workmf: all
	...
	cp $(NAME).dtx $(WORKMF)/source/latex/$(NAME)
	cp $(NAME).cls $(WORKMF)/tex/latex/$(NAME)
	cp rdamsdwg.sty $(WORKMF)/tex/latex/$(NAME)
	cp rda-bg-normal.jpeg rda-bg-title1.jpeg rda-bg-title2.jpeg $(WORKMF)/tex/latex/$(NAME)
	cp $(NAME).pdf $(WORKMF)/doc/latex/$(NAME)
	cp $(NAME)-slides.pdf $(WORKMF)/doc/latex/$(NAME)
	cp README $(WORKMF)/doc/latex/$(NAME)
zip: all
	mkdir $(TDIR)
	cp $(NAME).{pdf,dtx} $(NAME)-slides.pdf README Makefile rda-bg-normal.jpeg rda-bg-title1.jpeg rda-bg-title2.jpeg $(TDIR)
